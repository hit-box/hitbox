...
use crate::{CacheKey, CachePolicy, extractor::Extractor, predicate::{Predicate, PredicateError}};
...
where
    Self: Sized,
{
    async fn cache_policy<P, E>(self, predicates: P, extractors: E) -> Result<RequestCachePolicy<Self>, PredicateError>
    where
