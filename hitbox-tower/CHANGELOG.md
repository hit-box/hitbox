...
- **Breaking:** `CacheService` and builder use `HttpCacheStatusConfig` instead of `HeaderName`; added `.cache_name()` builder method ([#269](https://github.com/hit-box/hitbox/pull/269))
